...
import { firstAccount } from "@/interface/credentials";
import { COURIER_HTTP_TIMEOUT_MS } from "@/backend/config";
...
export function normalizeTrackonStatus(code: string | null, raw: string | null): string | null {
  if (code) {
